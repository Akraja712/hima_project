        ...
        <form action="<?php echo e(route('news.update', $news->id)); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="payment_gateway_type" name="payment_gateway_type" required>
                    <option value="instamojo" <?php echo e($news->payment_gateway_type == 'instamojo' ? 'selected' : ''); ?>>instamojo</option>
                    <option value="razorpay" <?php echo e($news->payment_gateway_type == 'razorpay' ? 'selected' : ''); ?>>razorpay</option>
                    <option value="upigateway" <?php echo e($news->payment_gateway_type == 'upigateway' ? 'selected' : ''); ?>>upigateway</option>
                    <option value="gpay" <?php echo e($news->payment_gateway_type == 'gpay' ? 'selected' : ''); ?>>gpay</option>
                </select>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/news/edit.blade.php ENDPATH**/ ?>