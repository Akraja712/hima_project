        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('screen_notifications.store')); ?>" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group mt-3">
                        <label for="day" class="form-label"><?php echo e(__('Day')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/screen_notifications/create.blade.php ENDPATH**/ ?>