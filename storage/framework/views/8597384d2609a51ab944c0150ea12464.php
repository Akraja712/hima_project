                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <p class="mb-0">
                                Showing 
                                <strong><?php echo e($users->firstItem()); ?></strong> 
                                to 
                                <strong><?php echo e($users->lastItem()); ?></strong> 
                                of 
                                <strong><?php echo e($users->total()); ?></strong> users
                            </p>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hima_project\resources\views/users/index.blade.php ENDPATH**/ ?>