...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12 mt-3">
         ...
         <div class="form-group col-md-12 mt-3">
            <?php echo e(Form::label('day', __('Day'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::select('day', [
                '' => __('Select Day'),
                'all' => __('all'),
                'Monday' => __('Monday'),
                'Tuesday' => __('Tuesday'),
...
<?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/screen_notifications/edit.blade.php ENDPATH**/ ?>