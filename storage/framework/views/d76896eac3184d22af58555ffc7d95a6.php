    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <!-- <li class="dash-item">
                ...
                <li class="dash-item">
                <a href="<?php echo e(route('withdrawalsreports.index')); ?>" class="dash-link">
                    <span class="dash-micon">
                        <i class="ti ti-wallet"></i> <!-- Icon for withdrawals -->
                    </span>
                    <span class="dash-mtext"><?php echo e(__('Withdrawals Reports')); ?></span>
                </a>
                </li>
                <li class="dash-item">
                ...
                <li class="dash-item">
                    ...
                    <li class="dash-item">
                    <a href="<?php echo e(route('screen_notifications.index')); ?>" class="dash-link">
                        <span class="dash-micon">
                            <i class="ti ti-bell"></i> <!-- Icon for notifications -->
                        </span>
...
<?php /**PATH C:\xampp\htdocs\hima_project\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>