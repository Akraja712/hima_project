                ...
                <form action="<?php echo e(route('users.index')); ?>" method="GET" class="mb-3">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3 ms-auto">
                            ...
                            <input type="text" name="search" id="search" class="form-control" value="<?php echo e(request()->get('search')); ?>" placeholder="Enter Name, Mobile" onkeyup="startFilterTimer()">
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/users/index.blade.php ENDPATH**/ ?>