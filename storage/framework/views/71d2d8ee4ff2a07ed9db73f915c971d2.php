    ...
    <div class="row">
        ...
        <div class="col-xxl-12 mb-3">
            ...
            <form method="GET" action="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="input-group-text" style="background-color:#b9406b; color: white;"><?php echo e(__('Filter by Language')); ?></span>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto text-end">
                                        <h4 class="m-0 text-primary"><?php echo e($today_recharge_id_count); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>