...
<div class="row">
    ...
    <form action="<?php echo e(route('usercalls.index')); ?>" method="GET" class="d-flex align-items-center flex-wrap">
    ...
    <div class="d-flex flex-column align-items-end ms-auto">
        ...
        <div class="mb-3" style="width: 300px;">
            ...
            <form action="<?php echo e(route('usercalls.index')); ?>" method="GET" class="d-flex">
        ...
        <div class="d-flex">
            <!-- Reset Audio Call -->
            <form action="<?php echo e(route('usercalls.updateuser')); ?>" method="POST" class="me-2">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="audio_status" value="0">
                <button type="submit" class="btn btn-warning"><?php echo e(__('Reset Audio Call')); ?></button>
            </form>

            <!-- Reset Video Call -->
            <form action="<?php echo e(route('usercalls.updateuser')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <p class="mb-0">
                                Showing 
                                <strong><?php echo e($usercalls->firstItem()); ?></strong> 
                                to 
                                <strong><?php echo e($usercalls->lastItem()); ?></strong> 
                                of 
                                <strong><?php echo e($usercalls->total()); ?></strong> usercalls
                            </p>
                        </div>
                        <div>
                            <?php echo e($usercalls->appends(request()->query())->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hima_project\resources\views/usercalls/index.blade.php ENDPATH**/ ?>