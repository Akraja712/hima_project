              ...
              <!-- Filter by Status and Language Form -->
                    <form action="<?php echo e(route('users-verification.index')); ?>" method="GET" class="mb-3">
                        <div class="row">
                            ...
                            <input type="date" name="date" id="date" class="form-control" value="<?php echo e(request()->get('date')); ?>" onchange="this.form.submit()">
                        </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/users-verification/index.blade.php ENDPATH**/ ?>