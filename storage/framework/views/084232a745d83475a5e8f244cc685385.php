    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('payments.downloadOrExport')); ?>" method="GET" id="paymentsForm">
                    <?php echo csrf_field(); ?>
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <button type="submit" name="action" value="download" class="btn btn-success d-block w-100">
                                <?php echo e(__('Download Invoices')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/payments/index.blade.php ENDPATH**/ ?>