                            ...
                            <tbody>
                                <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($withdrawal->bank ?? '-'); ?></td>
                                        <td><?php echo e($withdrawal->branch ?? '-'); ?></td>
                                        <td><?php echo e($withdrawal->ifsc ?? '-'); ?></td>
                                        <td><?php echo e($withdrawal->account_num ?? '-'); ?></td>
                                        <td><?php echo e($withdrawal->holder_name ?? '-'); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u743445510/domains/himaapp.in/public_html/resources/views/withdrawals/index.blade.php ENDPATH**/ ?>